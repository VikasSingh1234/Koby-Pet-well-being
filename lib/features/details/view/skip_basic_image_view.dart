...
import 'package:pet_wellbeing/common/design_system/bottomsheet.dart';
import 'package:pet_wellbeing/common/design_system/font_size.dart';
import '../../../common/design_system/color.dart';

class SkipBasicDetailsView extends StatefulWidget {
  String? name;
  SkipBasicDetailsView({super.key,this.name});

  @override
  State<SkipBasicDetailsView> createState() => _SkipBasicDetailsViewState();
}

class _SkipBasicDetailsViewState extends State<SkipBasicDetailsView> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                      text: "Just answer a few more questions about ",
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          color: Colors.black,
                          fontWeight: FontWeight.w600,
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(text: 'to get started.',
                          style: TextStyle(
                            fontFamily: 'Poppins',
                            color: Colors.black, fontSize: subHeadingTextSize,
                          ),
                        ),
                      ]
                  ),
